...
PowerShell. Dat leidt tot infostealers, remote-access-tools en in het ergste geval ransomware en datalekken.
Een publiek voorbeeld is de aanval op een Nederlandse gemeente in maart 2026, waarbij na een ClickFix-uitvoering
binnen twee dagen honderdduizenden bestanden werden geëxfiltreerd.
...
## Strategische keuze: veilig faciliteren

Er zijn grofweg twee richtingen. Dichttimmeren (het apparaat zoveel mogelijk beperken) en veilig faciliteren
...
restrictie in voor continu beheer. Het is alleen duurzaam als de regiecapaciteit er werkelijk is. Ontbreekt die,
dan verdient een striktere aanpak een serieuze afweging. Zie [07-veilig-faciliteren.md](07-veilig-faciliteren.md).
